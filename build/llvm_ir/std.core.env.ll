...
@"$ct.std.core.env.CompilerOptLevel" = linkonce global { i8, i64, ptr, i64, i64, i64, [4 x %"char[]"] } { i8 8, i64 0, ptr null, i64 4, i64 ptrtoint (ptr @"$ct.int" to i64), i64 4, [4 x %"char[]"] [%"char[]" { ptr @.enum.O0, i64 2 }, %"char[]" { ptr @.enum.O1, i64 2 }, %"char[]" { ptr @.enum.O2, i64 2 }, %"char[]" { ptr @.enum.O3, i64 2 }] }, align 8
...
@"$ct.std.core.env.MemoryEnvironment" = linkonce global { i8, i64, ptr, i64, i64, i64, [4 x %"char[]"] } { i8 8, i64 0, ptr null, i64 4, i64 ptrtoint (ptr @"$ct.int" to i64), i64 4, [4 x %"char[]"] [%"char[]" { ptr @.enum.NORMAL, i64 6 }, %"char[]" { ptr @.enum.SMALL, i64 5 }, %"char[]" { ptr @.enum.TINY, i64 4 }, %"char[]" { ptr @.enum.NONE, i64 4 }] }, align 8
...
@"$ct.std.core.env.ArchType" = linkonce global { i8, i64, ptr, i64, i64, i64, [52 x %"char[]"] } { i8 8, i64 0, ptr null, i64 4, i64 ptrtoint (ptr @"$ct.int" to i64), i64 52, [52 x %"char[]"] [%"char[]" { ptr @.enum.UNKNOWN, i64 7 }, %"char[]" { ptr @.enum.ARM, i64 3 }, %"char[]" { ptr @.enum.ARMB, i64 4 }, %"char[]" { ptr @.enum.AARCH64, i64 7 }, %"char[]" { ptr @.enum.AARCH64_BE, i64 10 }, %"char[]" { ptr @.enum.AARCH64_32, i64 10 }, %"char[]" { ptr @.enum.ARC, i64 3 }, %"char[]" { ptr @.enum.AVR, i64 3 }, %"char[]" { ptr @.enum.BPFEL, i64 5 }, %"char[]" { ptr @.enum.BPFEB, i64 5 }, %"char[]" { ptr @.enum.HEXAGON, i64 7 }, %"char[]" { ptr @.enum.MIPS, i64 4 }, %"char[]" { ptr @.enum.MIPSEL, i64 6 }, %"char[]" { ptr @.enum.MIPS64, i64 6 }, %"char[]" { ptr @.enum.MIPS64EL, i64 8 }, %"char[]" { ptr @.enum.MSP430, i64 6 }, %"char[]" { ptr @.enum.PPC, i64 3 }, %"char[]" { ptr @.enum.PPC64, i64 5 }, %"char[]" { ptr @.enum.PPC64LE, i64 7 }, %"char[]" { ptr @.enum.R600, i64 4 }, %"char[]" { ptr @.enum.AMDGCN, i64 6 }, %"char[]" { ptr @.enum.RISCV32, i64 7 }, %"char[]" { ptr @.enum.RISCV64, i64 7 }, %"char[]" { ptr @.enum.SPARC, i64 5 }, %"char[]" { ptr @.enum.SPARCV9, i64 7 }, %"char[]" { ptr @.enum.SPARCEL, i64 7 }, %"char[]" { ptr @.enum.SYSTEMZ, i64 7 }, %"char[]" { ptr @.enum.TCE, i64 3 }, %"char[]" { ptr @.enum.TCELE, i64 5 }, %"char[]" { ptr @.enum.THUMB, i64 5 }, %"char[]" { ptr @.enum.THUMBEB, i64 7 }, %"char[]" { ptr @.enum.X86, i64 3 }, %"char[]" { ptr @.enum.X86_64, i64 6 }, %"char[]" { ptr @.enum.XCORE, i64 5 }, %"char[]" { ptr @.enum.NVPTX, i64 5 }, %"char[]" { ptr @.enum.NVPTX64, i64 7 }, %"char[]" { ptr @.enum.LE32, i64 4 }, %"char[]" { ptr @.enum.LE64, i64 4 }, %"char[]" { ptr @.enum.AMDIL, i64 5 }, %"char[]" { ptr @.enum.AMDIL64, i64 7 }, %"char[]" { ptr @.enum.HSAIL, i64 5 }, %"char[]" { ptr @.enum.HSAIL64, i64 7 }, %"char[]" { ptr @.enum.SPIR, i64 4 }, %"char[]" { ptr @.enum.SPIR64, i64 6 }, %"char[]" { ptr @.enum.KALIMBA, i64 7 }, %"char[]" { ptr @.enum.SHAVE, i64 5 }, %"char[]" { ptr @.enum.LANAI, i64 5 }, %"char[]" { ptr @.enum.WASM32, i64 6 }, %"char[]" { ptr @.enum.WASM64, i64 6 }, %"char[]" { ptr @.enum.RSCRIPT32, i64 9 }, %"char[]" { ptr @.enum.RSCRIPT64, i64 9 }, %"char[]" { ptr @.enum.XTENSA, i64 6 }] }, align 8
@.str = private unnamed_addr constant [41 x i8] c"3e4d1de70e68cd5e4c604581c12db61fc0d8a96a\00", align 1
@std.core.env.COMPILER_BUILD_HASH = weak local_unnamed_addr constant %"char[]" { ptr @.str, i64 40 }, align 8, !dbg !0
@.str.42 = private unnamed_addr constant [11 x i8] c"2025-01-17\00", align 1
@std.core.env.COMPILER_BUILD_DATE = weak local_unnamed_addr constant %"char[]" { ptr @.str.42, i64 10 }, align 8, !dbg !12
@std.core.env.OS_TYPE = weak local_unnamed_addr constant i32 11, align 4, !dbg !14
@std.core.env.ARCH_TYPE = weak local_unnamed_addr constant i32 3, align 4, !dbg !55
@std.core.env.ARCH_32_BIT = weak local_unnamed_addr constant i8 0, align 1, !dbg !110
@std.core.env.ARCH_64_BIT = weak local_unnamed_addr constant i8 1, align 1, !dbg !113
@std.core.env.LIBC = weak local_unnamed_addr constant i8 1, align 1, !dbg !115
@std.core.env.NO_LIBC = weak local_unnamed_addr constant i8 0, align 1, !dbg !117
@std.core.env.COMPILER_OPT_LEVEL = weak local_unnamed_addr constant i32 0, align 4, !dbg !119
@std.core.env.BIG_ENDIAN = weak local_unnamed_addr constant i8 0, align 1, !dbg !127
@std.core.env.I128_NATIVE_SUPPORT = weak local_unnamed_addr constant i8 1, align 1, !dbg !129
@std.core.env.F16_SUPPORT = weak local_unnamed_addr constant i8 1, align 1, !dbg !131
@std.core.env.F128_SUPPORT = weak local_unnamed_addr constant i8 0, align 1, !dbg !133
@std.core.env.REGISTER_SIZE = weak local_unnamed_addr constant i32 64, align 4, !dbg !135
@std.core.env.COMPILER_SAFE_MODE = weak local_unnamed_addr constant i8 1, align 1, !dbg !137
@std.core.env.DEBUG_SYMBOLS = weak local_unnamed_addr constant i8 1, align 1, !dbg !139
@std.core.env.BACKTRACE = weak local_unnamed_addr constant i8 1, align 1, !dbg !141
@std.core.env.LLVM_VERSION = weak local_unnamed_addr constant i64 17, align 8, !dbg !143
@std.core.env.BENCHMARKING = weak local_unnamed_addr constant i8 0, align 1, !dbg !145
@std.core.env.TESTING = weak local_unnamed_addr constant i8 0, align 1, !dbg !147
@std.core.env.MEMORY_ENV = weak local_unnamed_addr constant i32 0, align 4, !dbg !149
@std.core.env.TRACK_MEMORY = weak local_unnamed_addr constant i8 1, align 1, !dbg !157
@std.core.env.X86_64 = weak local_unnamed_addr constant i8 0, align 1, !dbg !159
@std.core.env.X86 = weak local_unnamed_addr constant i8 0, align 1, !dbg !161
@std.core.env.AARCH64 = weak local_unnamed_addr constant i8 1, align 1, !dbg !163
@std.core.env.NATIVE_STACKTRACE = weak local_unnamed_addr constant i8 1, align 1, !dbg !165
@std.core.env.LINUX = weak local_unnamed_addr constant i8 0, align 1, !dbg !167
@std.core.env.DARWIN = weak local_unnamed_addr constant i8 1, align 1, !dbg !169
@std.core.env.WIN32 = weak local_unnamed_addr constant i8 0, align 1, !dbg !171
@std.core.env.POSIX = weak local_unnamed_addr constant i8 1, align 1, !dbg !173
@std.core.env.OPENBSD = weak local_unnamed_addr constant i8 0, align 1, !dbg !175
@std.core.env.FREEBSD = weak local_unnamed_addr constant i8 0, align 1, !dbg !177
@std.core.env.NETBSD = weak local_unnamed_addr constant i8 0, align 1, !dbg !179
@std.core.env.BSD_FAMILY = weak local_unnamed_addr constant i8 0, align 1, !dbg !181
@std.core.env.WASI = weak local_unnamed_addr constant i8 0, align 1, !dbg !183
@std.core.env.WASM_NOLIBC = weak local_unnamed_addr constant i8 0, align 1, !dbg !185
@std.core.env.ADDRESS_SANITIZER = weak local_unnamed_addr constant i8 0, align 1, !dbg !187
@std.core.env.MEMORY_SANITIZER = weak local_unnamed_addr constant i8 0, align 1, !dbg !189
@std.core.env.THREAD_SANITIZER = weak local_unnamed_addr constant i8 0, align 1, !dbg !191
@std.core.env.ANY_SANITIZER = weak local_unnamed_addr constant i8 0, align 1, !dbg !193
@std.core.env.BUILTIN_EXPECT_IS_DISABLED = weak local_unnamed_addr constant i8 0, align 1, !dbg !195
@std.core.env.BUILTIN_PREFETCH_IS_DISABLED = weak local_unnamed_addr constant i8 0, align 1, !dbg !197
...
!2 = !DIFile(filename: "env.c3", directory: "/opt/homebrew/lib/c3/std/core")
...
!201 = !{i32 2, !"wchar_size", i32 4}
!202 = !{i32 4, !"PIC Level", i32 2}
!203 = !{i32 1, !"uwtable", i32 1}
!204 = !{i32 2, !"frame-pointer", i32 1}
